...
<img src="assets/derived/logo-880.png" alt="vkML — Vulkan based machine learning library" width="440">
...
- **Vulkan is all-or-nothing**, by design rather than by omission — see
  ...
  reasoning behind it.
- **Missing layers:** Conv3d, gradient checkpointing.
  `python scripts/check_module_coverage.py` generates this list from the API rather than restating it — 30 of the manifesto's 34 P1 modules are present.
