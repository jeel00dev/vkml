...
T: dict[int, tuple] = {
    ...
    137: ("done", DEFECT,   PRODUCT, "CLOSED: max_pool2d had the same defect -- 9.6% -> 4.5% of a "
                                     "step. The forward's apparent 12% regression was NOISE, "
                                     "disproven by a frozen-baseline A/B; ADR 0011 section 4b", None),
