...
T: dict[int, tuple] = {
    ...
    118: ("open", DEFECT,   PRODUCT, "PARTLY DISPROVEN: 3 of the 8 'unmet' modules existed under "
                                     "torch's names 5 days before the audit. 28 of 34 present, "
                                     "6 real gaps, now generated by check_module_coverage.py", FOUND),
    ...
    130: ("done", DEFECT,   VERIFY,  "CLOSED: the P1 completeness list was measured by name grep "
                                     "against an API using torch's spellings, and was wrong 3 ways. "
                                     "The mapping is declared and gated now", None),
