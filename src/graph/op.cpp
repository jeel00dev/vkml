...
constexpr std::array<std::string_view, kNumOps> kOpNames = {
    ...
    "reshape",   "permute",       "slice",     "broadcast",  "squeeze",   "unsqueeze",

    "contiguous", "cast",         "cat",

    "add",       "sub",           "mul",       "div",        "pow",       "maximum",
    "minimum",

    "eq",        "lt",            "gt",        "le",         "ge",        "ne",

    "neg",       "abs",           "sign",      "square",     "sqrt",      "rsqrt",
    "reciprocal", "exp",          "log",       "erf",        "sin",       "cos",
    "tanh",
    "sigmoid",   "relu",          "gelu",      "silu",       "clamp",

    "sum",       "mean",          "max",       "min",        "prod",      "argmax",
    "argmin",
    ...
    "im2col",    "col2im",        "conv2d",    "max_pool2d", "avg_pool2d",
    "max_pool2d_backward",
    ...
    "where",     "masked_fill",   "dropout",   "triu",       "tril",
};
